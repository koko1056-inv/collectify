...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const content: any[] = [
      {
        type: "text",
        text: `${prompt}\n\n【厳密な指示】\n1. 最初に提供される画像は「ベースアバター」です。この画像の人物の顔立ち、髪型、表情、ポーズ、背景は一切変更しないでください。\n2. 2枚目以降の画像は「装着するグッズ」です。これらのグッズをベースアバターに自然に合成してください。\n3. ベースアバターの人物の特徴を完全に保持したまま、グッズのみを追加・装着してください。\n4. グッズの色、デザイン、形状を忠実に再現してください。\n5. 最終的な画像は、元のアバターにグッズを着用した自然な見た目になるようにしてください。`
      },
      {
        type: "image_url",
        image_url: {
