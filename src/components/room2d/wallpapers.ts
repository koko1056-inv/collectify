...
export const WALLPAPERS: WallpaperPreset[] = [
  // === クリーン ===
  {
    ...
    descriptionEn: "A clean, crisp white room",
  ...
  },
  {
    ...
    descriptionEn: "A warm cream tone",
  ...
  // === キュート ===
  {
    ...
    descriptionEn: "A pink room with drifting cherry blossoms",
  ...
  },
  {
    ...
    descriptionEn: "A dreamy pastel space",
  ...
  },
  {
    ...
    descriptionEn: "A fresh cafe vibe",
  ...
  },
  {
    ...
    descriptionEn: "A gentle touch of lavender",
  ...
  // === エレガント ===
  {
    ...
    descriptionEn: "Calm, deep green tones",
  ...
  },
  {
    ...
    descriptionEn: "The mood of a late-night bar",
  ...
  },
  {
    ...
    category: "vivid",
    description: "海辺のリゾート",
    descriptionEn: "A seaside resort",
  ...
  // === テーマ ===
  {
    ...
    descriptionEn: "A sacred shrine at sunset",
  ...
  },
  {
    ...
    descriptionEn: "RGB lighting at full blast",
...
export const WALLPAPER_CATEGORY_LABELS: Record<WallpaperCategory, { label: string; labelEn: string; icon: string }> = {
  clean: { label: "クリーン", labelEn: "Clean", icon: "⚪" },
  cute: { label: "キュート", labelEn: "Cute", icon: "🌸" },
  elegant: { label: "エレガント", labelEn: "Elegant", icon: "🌙" },
  vivid: { label: "ビビッド", labelEn: "Vivid", icon: "🌃" },
  themed: { label: "テーマ", labelEn: "Themed", icon: "⛩️" },
};
