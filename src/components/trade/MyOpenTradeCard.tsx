...
export function MyOpenTradeCard({ trade, onCancelSuccess }: MyOpenTradeCardProps) {
  ...
  return (
    <Card className="overflow-hidden border border-gray-200 hover:border-gray-300 transition-colors rounded-xl shadow-sm hover:shadow-md animate-fade-in">
      <CardHeader className="p-3 pb-0 bg-gray-50">
        ...
        <div className="space-y-3 mt-1">
          <div className="space-y-1">
            ...
            <div className="border rounded-lg p-2 flex items-center space-x-2 hover:bg-gray-50 transition-colors group border-gray-200">
              ...
              <span className="text-sm truncate flex-1">{trade.offered_item.title}</span>
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div className="border rounded-lg p-2 flex items-center space-x-2 hover:bg-gray-50 transition-colors group border-gray-200">
              ...
              <span className="text-sm truncate flex-1">{trade.requested_item.title}</span>
            </div>
          </div>
        </div>
        
        {trade.message && (
          <div className="mt-3 p-2 bg-gray-50 rounded-lg border-l-4 border-gray-300">
            <p className="text-xs text-gray-700 italic line-clamp-2">{trade.message}</p>
          </div>
        )}
      </CardContent>
      <CardFooter className="bg-gray-50 p-2 flex justify-end">
        <Button 
          ...
          className="rounded-full border-gray-200 text-gray-600 hover:bg-gray-100 text-xs py-1"
        >
