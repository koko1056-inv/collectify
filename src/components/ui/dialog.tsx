...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left text-popover-foreground",
      className
    )}
    {...props}
  />
