...
import { Home, Heart, Eye, Loader2, Pencil, Plus, Sparkles, User, Image, Compass, Package, ArrowRight, TrendingUp, ChevronRight, Star, BookOpen, Crown, Award, Trophy, Wand2, Shirt } from "lucide-react";
